...
export class descriçãoDaMigration1653430487468 implements MigrationInterface {
    name = 'descriçãoDaMigration1653430487468'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "address" ADD CONSTRAINT "FK_7123516bdb2309b0f216dd53135" FOREIGN KEY ("userCodId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "address" DROP CONSTRAINT "FK_7123516bdb2309b0f216dd53135"`);
