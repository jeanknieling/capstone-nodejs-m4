...
var productsRoutes = function () {
    ...
    routes.post("/product", (0, express_yup_middleware_1.expressYupMiddleware)({ schemaValidator: listProductByName_validation_1.default }), authUser_middleware_1.authUser, productNotFound_middleware_1.default, productListByName_controller_1.default);
    routes.post("/category", (0, express_yup_middleware_1.expressYupMiddleware)({
    ...
    routes.delete("/changes/:id", (0, express_yup_middleware_1.expressYupMiddleware)({ schemaValidator: deleteProduct_validator_1.default }), authUser_middleware_1.authUser, authUser_middleware_1.verifyisAdmMiddleware, productNotRegistered_middleware_1.default, productDelete_controller_1.default);
    return routes;
};
