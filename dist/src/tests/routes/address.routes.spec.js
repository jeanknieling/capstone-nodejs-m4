...
describe("Testing adress routes", function () {
    var connection;
    ...
    it("Should create a new address in the database", function () { return __awaiter(void 0, void 0, void 0, function () {
        var token, zipcode, street, number, neighborhood, complement, newAddress, createNewAddres;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, supertest_1.default)(app_1.default)
                            ...
                            .send(newAddress)];
                case 2:
                    createNewAddres = _a.sent();
                    expect(createNewAddres.status).toBe(201);
                    return [2 /*return*/];
            }
        });
    }); });
    it("Should list all addresses registered in the database", function () { return __awaiter(void 0, void 0, void 0, function () {
        var token, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, userLoginAdmTrue()];
    ...
    it("Should update the address from de database", function () { return __awaiter(void 0, void 0, void 0, function () {
        var token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, userLoginAdmTrue()];
...
describe("Testing adress routes errors", function () {
    var connection;
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it("Should fail at address registration", function () { return __awaiter(void 0, void 0, void 0, function () {
        var token, zipcode, street, number, neighborhood, complement, newAddress, createNewAddres;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it("Should fail to list all addresses", function () { return __awaiter(void 0, void 0, void 0, function () {
        var createNewAddres;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app_1.default).post("/address")];
                case 1:
                    createNewAddres = _a.sent();
                    expect(createNewAddres.status).toBe(401);
                    return [2 /*return*/];
