...
var delProductService = function (userId, productId) { return __awaiter(void 0, void 0, void 0, function () {
    var userRepository, user, cartRepository, cart;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                if (cart.products.filter(function (prod) { return prod.id === productId; }).length === 0) {
                    throw new Error("Product isn't in the cart");
                }
                cart.products = cart.products.filter(function (prod) { return prod.id !== productId; });
                cart.total = (0, checkDate_1.fixedFloat)(cart.products.reduce(function (acc, prod) { return acc + prod.price; }, 0));
...
exports.default = delProductService;
