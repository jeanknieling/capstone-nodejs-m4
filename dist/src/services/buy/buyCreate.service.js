...
var buy_entity_1 = require("../../entities/buy.entity");
var cart_entity_1 = require("../../entities/cart.entity");
var user_entity_1 = require("../../entities/user.entity");
var appError_1 = require("../../errors/appError");
var buyCreateService = function (userId) { return __awaiter(void 0, void 0, void 0, function () {
    var cartRepository, userRepository, buyRepository, user, cart, buy, newBuy;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                buyRepository = data_source_1.AppDataSource.getRepository(buy_entity_1.Buy);
            ...
            case 4:
                _a.sent();
                newBuy = buyRepository.find({
                    where: {
                        id: buy.id,
                    },
                });
                return [2 /*return*/, newBuy];
