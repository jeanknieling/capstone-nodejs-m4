...
var productUpdateService = function (id, name, description, price, category) { return __awaiter(void 0, void 0, void 0, function () {
    var productRepository, products, categoryRepository, categories, categoryDatabase, product, newName, newDescription, newPrice, newCategory, message;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                categories = _a.sent();
                categoryDatabase = categories.find(function (cat) { return cat.name === category; });
                product = products.find(function (product) { return product.id === id; });
                if (product.name === undefined) {
                    throw new appError_1.AppError(404, "Product not found");
                }
                newName = !name ? product.name : name;
                newDescription = !description ? product.description : description;
                newPrice = !price ? product.price : price;
                newCategory = categoryDatabase;
