...
var productDeleteService = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var productRepository, products, product, message;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, productRepository.delete(product.id)];
            case 2:
                _a.sent();
                message = {
                    status: true,
...
exports.default = productDeleteService;
