...
var userUpdade_service_1 = __importDefault(require("../../services/user/userUpdade.service"));
var userUpdateController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, nickname, password, user, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, userUpdade_service_1.default)(id, nickname, password)];
            case 1:
                user = _b.sent();
